...
public class DefaultTrainingcommerceserviceService implements TrainingcommerceserviceService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTrainingcommerceserviceService.class);
	...
	{
		return DefaultTrainingcommerceserviceService.class.getResourceAsStream("/trainingcommerceservice/sap-hybris-platform.png");
	}
